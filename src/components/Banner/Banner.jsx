...
const Banner = () => {
    return (
        <div className=' max-w-[1200px] mx-auto flex justify-between items-center my-10 gap-4'>
            <div className='w-[708px] h-[250px] bg-amber-300 flex flex-col justify-center items-center text-center gap-2 text-white'
                style={{
